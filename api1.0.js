(function() {
  ...
  settings = (function() {
    ...
    settings.prototype.activity = function(obj) {
      if (obj.type === 'message') return this.users[obj.fromID].updateActivity();
    };
    ...
    settings.prototype.implode = function() {
      ...
      for (item in this) {
        val = this[item];
        if (typeof this[item] === 'object') delete this[item];
      }
  ...
  User = (function() {
    ...
    User.prototype.getIsDj = function() {
      ...
      for (_i = 0, _len = DJs.length; _i < _len; _i++) {
        dj = DJs[_i];
        if (this.user.id === dj.id) return true;
      }
      return false;
    };
  ...
  RoomHelper = (function() {
    ...
    RoomHelper.prototype.lookupUser = function(username) {
      ...
      for (id in _ref) {
        u = _ref[id];
        if (u.getUser().username === username) return u.getUser();
      }
      return false;
    };
  ...
  msToStr = function(msTime) {
    ...
    if (timeAway['days'] !== 0) msg += timeAway['days'].toString() + 'd';
    if (timeAway['hours'] !== 0) msg += timeAway['hours'].toString() + 'h';
    if (timeAway['minutes'] !== 0) msg += timeAway['minutes'].toString() + 'm';
    if (timeAway['seconds'] !== 0) msg += timeAway['seconds'].toString() + 's';
    if (msg !== '') {
      return msg;
    } else {
      return false;
      ...
      if (typeof this.command === 'string') {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (this.parseType === 'exact') {
            ...
            if (msg.substr(0, command.length) === command) return true;
          } else if (this.parseType === 'contains') {
            if (msg.indexOf(command) !== -1) return true;
          }
        }
        return false;
      }
  ...
  downloadCommand = (function(_super) {
    ...
    downloadCommand.prototype.functionality = function() {
      ...
      if (!(data.currentsong != null)) return;
  ...
  pushCommand = (function(_super) {
    ...
    pushCommand.prototype.functionality = function() {
      ...
      if (msg.length > this.command.length + 2) {
        ...
        if (user !== false) return API.moderateAddDJ(user.id);
      }
    };
  ...
  commandsCommand = (function(_super) {
    ...
    commandsCommand.prototype.functionality = function() {
      var allowedUserLevels, c, cc, cmd, msg, user, _i, _j, _len, _len2, _ref, _ref2;
      allowedUserLevels = [];
  ...
  disconnectLookupCommand = (function(_super) {
    ...
    disconnectLookupCommand.prototype.functionality = function() {
      var cmd, dcHour, dcLookupId, dcMeridian, dcMins, dcSongsAgo, dcTimeStr, dcUser, disconnectInstances, givenName, id, recentDisconnect, resp, u, _i, _len, _ref, _ref2;
        ...
        for (id in _ref) {
          ...
          if (u.getUser().username === givenName) {
            ...
            for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
              dcUser = _ref2[_i];
              if (dcUser.id === dcLookupId) disconnectInstances.push(dcUser);
            }
            if (disconnectInstances.length > 0) {
              ...
              if (dcMins < 10) dcMins = '0' + dcMins.toString();
              ...
              if (recentDisconnect.waitlistPosition !== void 0) {
                ...
                if (recentDisconnect.waitlistPosition > 1) resp += 's';
  ...
  handleNewSong = function(obj) {
    ...
    if (data.forceSkip) {
      ...
      return setTimeout(function() {
        var cMedia;
        cMedia = API.getMedia();
        if (cMedia.id === songId) return API.moderateForceSkip();
