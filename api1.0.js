...
(function() {
    if (!requirejs.defined('a79f1/d0bf6/c7e2b'))
        return API.chatLog('This version of plug&#179; is not compatible with this version of plug.dj', true), false;

    define('plugCubed/Model', ['jquery', 'underscore', 'a79f1/d0bf6/c7e2b', 'a79f1/d0bf6/a9c0e', 'a79f1/f40ce/b4223', 'a79f1/ee391/bb182', 'a79f1/a3ac7/bb9ef', 'a79f1/e414b/af520', 'a79f1/b8693/e43a8', 'a79f1/db1f0/ff1de', 'a79f1/db1f0/dc996', 'a79f1/e414b/e714a', 'lang/Lang', 'a79f1/de60f/cd47a/ad93f', 'a79f1/b8693/aaa44', 'a79f1/b8693/c2035', 'plugCubed/StyleManager', 'a79f1/de60f/cd47a/d427d/bbc0a', 'a79f1/de60f/cd47a/d427d/ae851', 'plugCubed/RoomUserListRow', 'plugCubed/Lang', 'plugCubed/Utils', 'a79f1/ee391/e3612', 'a79f1/e414b/c02b6', 'plugCubed/dialogs/CustomChatColors', 'plugCubed/dialogs/Commands', 'plugCubed/Slider', 'plugCubed/VolumeView'], function($, _, Class, Context, Chat, LocalStorage, Utils, Room, MCE, Socket, SIO, TUM, Lang, Audience, RJE, RSE, Styles, RoomUserListView, RoomUserListRow, _RoomUserListRow, p3Lang, p3Utils, DB, PlaybackModel, dialogColors, dialogCommands, Slider, VolumeView) {
        ...
        function onChatReceived(data) {
            ...
            if (p3Utils.isPlugCubedDonator(data.from.id))
                data.type += ' is-donator';
        ...
        function __init() {
            ...
            $('body').prepend('<link rel="stylesheet" type="text/css" id="plugcubed-css" href="https://raw2.github.com/xSidewinderx/swagapi/master/plugCubed.css" />');
    ...
    define('plugCubed/dialogs/CustomChatColors', ['jquery', 'a79f1/d0bf6/c7e2b', 'lang/Lang', 'a79f1/d0bf6/a9c0e', 'plugCubed/Lang'], function($, b, c, d, p3Lang) {
    ...
    define('plugCubed/dialogs/Userinfo', ['jquery', 'a79f1/de60f/fce90/c1714', 'lang/Lang', 'a79f1/d0bf6/c7e2b', 'a79f1/d0bf6/a9c0e', 'a79f1/b8693/d8fc3', 'plugCubed/Lang'], function($, b, c, d, e, f, p3Lang) {
        var a = d.extend({
            init: function(id) {
    ...
    define('plugCubed/dialogs/Commands', ['jquery', 'a79f1/d0bf6/c7e2b', 'lang/Lang', 'plugCubed/Lang', 'plugCubed/Utils'], function($, b, c, p3Lang, p3Utils) {
        var userCommands = [
    ...
    define('plugCubed/StyleManager', ['jquery', 'a79f1/d0bf6/c7e2b'], function($, Class) {
        var obj,
            styles = {},
            update = function() {
                var a = '';
    ...
    define('plugCubed/Utils', ['a79f1/de60f/cd47a/eef5e/bf125'], function(PopoutView) {
        var cleanMessage = function(input) {
            ...
            donators = [];
        $.getJSON('https://d1rfegul30378.cloudfront.net/alpha/donators.json', function(data) {
            donators = data;
        });
        return {
    ...
    define('plugCubed/RoomUserListRow', ['jquery', 'a79f1/de60f/cd47a/d427d/b4d4d', 'plugCubed/Utils'], function($, RoomUserListRow, p3Utils) {
    ...
    define('plugCubed/Lang', ['jquery', 'a79f1/d0bf6/c7e2b'], function($, Class) {
        var language = {},
            isLoaded = false,
            Lang = Class.extend({
                init: function() {
    ...
    define('plugCubed/Slider', ['jquery', 'a79f1/d0bf6/c7e2b'], function($, Class) {
        return Class.extend({
    ...
    define('plugCubed/Loader', ['jquery', 'a79f1/d0bf6/c7e2b', 'plugCubed/Model', 'a79f1/ee391/bb182', 'a79f1/de60f/fce90/c1714', 'plugCubed/Lang', 'plugCubed/Utils'], function($, Class, Model, LocalStorage, ADV, p3Lang, p3Utils) {
    ...
    */
    define('plugCubed/VolumeView', ['jquery', 'underscore', 'a79f1/de60f/cd47a/dd003/da283', 'a79f1/e414b/c02b6', 'hbs!template/room/playback/Volume', 'a79f1/d0bf6/a9c0e', 'plugCubed/Lang'], function($, e, original, r, s, Context, p3Lang) {
